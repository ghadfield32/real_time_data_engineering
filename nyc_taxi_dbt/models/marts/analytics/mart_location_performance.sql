/*
    ...
    Aggregates trip data by pickup zone to show which zones
    generate the most trips, revenue, and tips. Includes
    the most common dropoff zone and peak hour for each location.
*/
...
final as (
    select
        ...
        -- busiest hour
        mode(pickup_hour) as peak_pickup_hour
