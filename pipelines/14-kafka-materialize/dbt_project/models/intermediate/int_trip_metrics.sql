/*
    ...
    For Pipeline 14 (Materialize), the silver MV already computes all metrics.
...
select
    ...
    -- Already computed in Materialize silver MV
    trip_duration_minutes,
    avg_speed_mph,
    cost_per_mile,
    tip_percentage,

    -- Time dimensions (already computed in Materialize silver MV)
    pickup_date,
    pickup_hour,
    pickup_day_of_week,
    is_weekend,
