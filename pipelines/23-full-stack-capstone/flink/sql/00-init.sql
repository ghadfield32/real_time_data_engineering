-- =============================================================================
-- Pipeline 23: Flink SQL - Session Initialization
-- =============================================================================
-- Creates the Iceberg catalog for the capstone pipeline. This file is used as
-- an init script (-i flag) for all subsequent SQL files so they share the same
-- catalog within a single session.
--
