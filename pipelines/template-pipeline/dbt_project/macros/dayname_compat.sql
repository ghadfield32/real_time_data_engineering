-- =============================================================================
-- Macro: dayname_compat (+ monthname_compat + mode_compat)
-- =============================================================================
-- Cross-database compatibility macros for common SQL functions that differ
-- between DuckDB and PostgreSQL/RisingWave.
--
