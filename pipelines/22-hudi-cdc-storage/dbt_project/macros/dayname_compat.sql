...
{% macro dayname_compat(col) %}
    {{ return(adapter.dispatch('dayname_compat', 'nyc_taxi_pipeline_22')(col)) }}
{% endmacro %}
...
{% macro monthname_compat(col) %}
    {{ return(adapter.dispatch('monthname_compat', 'nyc_taxi_pipeline_22')(col)) }}
{% endmacro %}
...
{% macro mode_compat(col) %}
    {{ return(adapter.dispatch('mode_compat', 'nyc_taxi_pipeline_22')(col)) }}
{% endmacro %}
